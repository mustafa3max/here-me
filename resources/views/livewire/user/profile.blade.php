...
@section('page-title')
    {{ __('not_seo.title_profile', ['USER' => $user->name]) }}
@endsection

@section('page-description')
    {{ __('not_seo.description_profile', ['USER' => $user->name]) }}
@endsection
...
<div class="grid grid-cols-1 gap-2" x-data="{ changeImage: false, }">
    ...
    <x-containers.side side="1">
        <div class="flex flex-col gap-2 bg-secondary-light dark:bg-secondary-dark">
